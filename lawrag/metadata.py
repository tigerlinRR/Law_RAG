...
METADATA_SCHEMA = {
    ...
    "required": ["doc_type", "title", "parties", "client", "doc_date"],
}

_SYSTEM = (
    "You classify legal documents for a law firm's internal library. From the text, "
    "identify: doc_type (a short canonical label such as 'NDA', 'S-8', 'Master "
    ...
    "string if none). Use ONLY information present in the text. Never invent."
)
